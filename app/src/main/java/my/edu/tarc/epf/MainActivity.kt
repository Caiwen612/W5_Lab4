...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Make use of Host, Controller, graph

        //Fragment Manager = Controller, object generated by system
    }

    override fun onCreateOptionsMenu(menu: Menu): Boolean { //Menu visibility
